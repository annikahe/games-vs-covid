...
[
  ...
  score-player         ;; current total score of the player in the game
]
...
to distribute-cost-stay
  ask workers
  [
    set cost-stay random-normal 3 1
  ]
end
...
to decide
   ...
   if player-strategy = "random-strategy" [
...
to become-infected  ;; turtle procedure
  ...
  set score-player (score-player - cost-disease)
end
